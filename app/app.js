...
var _appBar = _interopRequireDefault(require("./components/app-bar"));
...
function (_React$Component) {
  ...
  function App(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "routePage", function (page) {
      _this.setState({
        pageRouted: page
      });
    });
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react["default"].createElement("div", null, _react["default"].createElement(_Dialog["default"], {
        ...
        component: this.state.pageRouted
      })))));
    }
  }]);
